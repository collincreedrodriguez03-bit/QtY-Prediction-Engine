...
class PredictionEngineTests {
    ...
    fun testUpPredictionWhenFactorsBullish() {
        ...
        assertTrue("Score should be > 0.5 for UP, got ${prediction.score}", prediction.score > 0.5)
    ...
    fun testDownPredictionWhenFactorsBearish() {
        ...
        assertTrue("Score should be < 0.5 for DOWN, got ${prediction.score}", prediction.score < 0.5)
    ...
    fun testNoTradeWhenMixedSignals() {
        ...
        assertTrue("Score should be near 0.5, got ${prediction.score}", prediction.score in 0.3..0.7)
    }
    ...
    fun testScoreRangeBoundedZeroToOne() {
        ...
        assertTrue(highPred.score >= 0.5)
        assertTrue(lowPred.score <= 0.5)
    }
    ...
    fun testStrengthLevelsAssignedCorrectly() {
        ...
        assertTrue(pred.strength in listOf("STRONG", "MEDIUM"))
    }
}
